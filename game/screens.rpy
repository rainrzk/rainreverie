...
image main_menu = Movie(play="gui/rainy.webm")
transform background_fade:
    alpha 0.0
    pause 2.0
    linear 2.0 alpha 1.0
transform video_fade:
    alpha 0.5
transform frame_fade:
    alpha 0.0
    pause 2.0
...
screen main_menu():
    ...
    add gui.main_menu_background at background_fade

    # 播放视频（考虑透明度，使其略显透明）
    add "main_menu" at video_fade
...
screen about():
    ...
    use game_menu(_("关于"), scroll="viewport"):
        ...
        vbox:
            ...
            text _("Original Work\n\n    東方Project\n\n\nStory\n\n    ウサホリ《光を唱えて》\n\n\nStudio\n\n    Visual Cube\n\n\nProgram\n\n    Reitsuki Hikari\n\n\nTrack List\n\n    永遠の巫女 - Re:Volte\n    神社の前で - 夜秋\n    流星スペクトラ - Foxtail-Grass Studio\n    東の国の眠らない夜 - ファクトリー・ノイズ&AG\n    さくらさくら ~ Japanize Dream - Demetori\n\n\nArtwork\n\n    dairi\n    東方LostWord\n    萃\n    りすたる\n    遠坂あさぎ\n\n\nVoice Cast\n\n    宮尾 時雨(skytnt) as 霧雨 魔理沙")
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    style_prefix "radio"
                    label _("语言")
                    textbutton _("English") action Function(set_language, "english")
                    textbutton _("日本語") action Function(set_language, "japanese")
                    textbutton _("简体中文") action Function(set_language, "None")
